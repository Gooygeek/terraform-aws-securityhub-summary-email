...
def lambda_handler(event, context):
    ...
    insightLabelMap = {
        ...
        "health_by_severity": "AWS Health Events by severity:",
        "guardduty_by_severity": "GuardDuty threat detection findings by severity:",
        "macie_by_severity": "Macie findings by severity:",
        "iam_by_severity": "IAM Access Analyzer findings by severity:",
        "ta_by_severity": "Trusted Advisor findings by severity:",
        "inspector_by_severity": "Inspector findings by severity:",
        "ssmpm_by_severity": "Systems Manager Patch Manager findings by severity:",
        "ssmops_by_severity": "Systems Manager OpsCenter and Explorer findings by severity:",
        "fwman_by_severity": "Firewall Manager findings by severity:",
        "auditman_by_severity": "Audit Manager findings by severity:",
        "detective_by_severity": "Detective findings by severity:",
        "chatbot_by_severity": "Chatbot findings by severity:",
